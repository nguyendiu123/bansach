    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="khoa_li_luan_chinh_tri.php">Sách Khoa Lí Luận Chính Trị</a></li>
            </ol>
        </div>
    </section>
            ...
            <div class="noidung bg-white" style=" width: 100%;">
                ...
                <div >
                    ...
                    $sql = "
                              ...
                              WHERE ten_khoa=N'Khoa Lí Luận Chính Trị'
            ...
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="gioithieu">
                        ...
                        <a href="#">Giới thiệu về Nhà sách Học Viện Ngân Hàng</a>
