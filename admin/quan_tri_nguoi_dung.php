                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><a href="nguoi_dung_sua.php?id=<?php echo $row['nguoi_dung_id'];?>"> Sửa </a></td>
                                            <td style="text-align: center"><a href="nguoi_dung_xoa.php?id=<?php echo $row['nguoi_dung_id'];?>"> Xóa </a></td>
